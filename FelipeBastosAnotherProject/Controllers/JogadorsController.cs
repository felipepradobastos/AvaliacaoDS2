...
namespace FelipeBastosAnotherProject.Controllers
{
    public class JogadorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Idade,Nacionalidade,Nome")] Jogador jogador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Idade,Nacionalidade,Nome")] Jogador jogador)
        {
            if (id != jogador.Id)
            {
                return NotFound();
